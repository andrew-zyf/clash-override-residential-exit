// Standalone DNS and domain sniffer override
//
// Only writes config.dns and config.sniffer. It does not create proxy groups,
// does not inject residential chain proxy nodes, and does not modify routing rules.
//
// Use this option when you only need DNS anti-pollution, Fake-IP, and SNI/Host
...
function main(config) {
  return DNS_SNIFFER_MODULE.apply(config);
}
